...
### ログイン画面
![ログイン画面](./screenshots/login.jpg)

### メインページ
![メインページ](./screenshots/main.jpg)

### 学習画面
![学習画面](./screenshots/study.jpg)

### テスト画面
![テスト画面](./screenshots/test.jpg)

### マイページ
![マイページ](./screenshots/mypage.jpg)
...
| オ・テヨン（サブリーダー） | 漢字DBモデリング設計・管理、復習機能 |
